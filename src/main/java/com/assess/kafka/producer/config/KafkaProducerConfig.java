...
public class KafkaProducerConfig {
    @Value("${spring.kafka.product.bootstrap-servers}")
    private String bootstrapServers;

    @Bean
    public <K, V> ProducerFactory<K, V> createProductProducerFactory() {
    ...
    @Bean
    public <K, V> KafkaTemplate<K, V> createProductKafkaTemplate() {
