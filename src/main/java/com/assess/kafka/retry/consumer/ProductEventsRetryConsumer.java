...
@Service
@Slf4j
public class ProductEventsRetryConsumer {

    @Value(value = "${spring.kafka.product.bootstrap-servers:")
    private String bootstrapServer;
    @Value(value = "${spring.kafka.product.consumer.group-id:")
    ...
    public ConcurrentKafkaListenerContainerFactory<String, ProductEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ProductEvent> concurrentKafkaListenerContainerFactory
